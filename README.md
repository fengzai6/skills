...
- `main`
  - 路径: [rules/main.md](rules/main.md) (3845 tokens)
...
- `git-workflow`
  - 路径: [skills/git-workflow/SKILL.md](skills/git-workflow/SKILL.md) (1321 tokens)
...
│   │   └── SKILL.md
│   ├── test-review/            # 测试完备性审查 skill
│   │   └── SKILL.md
│   └── man-day-quote/          # 人天报价 skill
│       ├── SKILL.md
│       └── scripts/
│           └── generate-quote-xlsx.py
├── CLAUDE.md                   # 本仓库编写规范
└── README.md                   # 本文件
```
